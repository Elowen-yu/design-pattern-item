...
//model
public class PayStatusEditPanel extends JInternalFrame {//所有编辑页面都可以用这个窗口
    public PayStatusEditPanel(JLabel[] labels, int number, Object selectedId) {
...
//        //selectedId > -1 modify
        if (id > -1){//修改
            //得到选中的数组 并放进文本框
            Object[] oldData = PSDAO.findById(id);
