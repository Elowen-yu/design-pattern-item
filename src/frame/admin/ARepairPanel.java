...
public class ARepairPanel extends JInternalFrame {
    //是一个tablepanel
    ...
    public ARepairPanel() {
        ...
        //修改/添加窗口的文本数组
        JLabel[] labels = {new JLabel("项目"), new JLabel("报修人"), new JLabel("住址"),
        ...
        addButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                //切换面板
                AdminPanel.setContent(new ARepairEditPanel(labels, labels.length, -1));
            }
        });
        delButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                AdminPanel.setContent(new ARepairPanel());
            }
        });
        modifyButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (table.getSelectedRow() == -1)
                    ...
                    int row = table.getSelectedRow();
                    int selectedId = (int) table.getValueAt(row, 0);
                    AdminPanel.setContent(new ARepairEditPanel(labels, labels.length, selectedId));
                }
        ...
        searchButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                Object[][] searchData = ARepairDAO.search(1, searchText);
                //创建新DefaultTableModel并传入新二维数组和属性
                TableModel newTableModel = new DefaultTableModel(searchData, ARepairDAO.columnNames);
                //更新表格
