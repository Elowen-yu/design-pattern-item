...
public class PayAnnouncePanel extends JInternalFrame {
    //是一个tablepanel
    //缴费项目JMenuItem JTable
    //序号 项目 收费标准 截止日期
    public PayAnnouncePanel() {
...
//                ResDAO.columnNames);//添加两个数组进去
        ...
        addButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                //切换面板
                AdminPanel.setContent(new PayAnnounceEditPanel(labels, labels.length, -1));
            }
        });
        delButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                PADAO.remove(selectedId);
                AdminPanel.setContent(new PayAnnouncePanel());
            }
        });
        modifyButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (table.getSelectedRow() == -1)
                    ...
                    int row = table.getSelectedRow();
                    int selectedId = (int) table.getValueAt(row, 0);
                    AdminPanel.setContent(new PayAnnounceEditPanel(labels, labels.length, selectedId));
                }
